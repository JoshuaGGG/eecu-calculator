...
var careerValue = selectedCareer.dataset.value;
...
document.querySelector(".federal-taxes-input").value = federalTaxes;
document.querySelector(".state-taxes-input").value = stateTaxes;
document.querySelector(".social-security-input").value = socialSecurity;
document.querySelector(".medicare-input").value = medicare;
